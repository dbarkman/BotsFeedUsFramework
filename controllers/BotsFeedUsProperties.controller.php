...
/**
 * BotsFeedUsProperties.class.php
 * Description:
 *
 */

class BotsFeedUsProperties extends Properties
{
	private $_propertiesFile;
	const PROP_LOGFILE = "botsFeedUs.log.file";
	const PROP_LOGLEVEL = "botsFeedUs.log.level";

	public function __construct()
	{
		$this->_propertiesFile = dirname(__FILE__) . '/../config/botsFeedUs.properties';
